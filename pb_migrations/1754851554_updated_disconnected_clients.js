...
migrate((app) => {
  ...
  // remove field
  collection.fields.removeById("_clone_NAJU")

  // remove field
  collection.fields.removeById("_clone_AZpA")

  // remove field
  collection.fields.removeById("_clone_jYBk")

  // remove field
  collection.fields.removeById("_clone_ldpZ")

  // remove field
  collection.fields.removeById("_clone_7zn8")

  // remove field
  collection.fields.removeById("_clone_hO1Z")

  // remove field
  collection.fields.removeById("_clone_7LFW")

  // remove field
  collection.fields.removeById("_clone_U7RT")
