...
migrate((app) => {
  ...
  // remove field
  collection.fields.removeById("_clone_uMkq")

  // remove field
  collection.fields.removeById("_clone_IBdE")

  // remove field
  collection.fields.removeById("_clone_ciOH")

  // remove field
  collection.fields.removeById("_clone_TU9M")

  // remove field
  collection.fields.removeById("_clone_lDWj")

  // remove field
  collection.fields.removeById("_clone_LWbQ")

  // remove field
  collection.fields.removeById("_clone_aHEa")

  // remove field
  collection.fields.removeById("_clone_pdnh")

  // remove field
  collection.fields.removeById("_clone_ZKc4")

  // remove field
  collection.fields.removeById("_clone_lq4H")

  // remove field
  collection.fields.removeById("_clone_yv7g")
